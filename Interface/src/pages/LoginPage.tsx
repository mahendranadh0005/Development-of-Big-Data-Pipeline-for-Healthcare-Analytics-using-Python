      ...
      <div className="container mx-auto px-4 py-12 min-h-screen flex flex-col">
        ...
        <header className="text-center mb-12 fade-in">
          ...
          <p className="text-muted-foreground max-w-md mx-auto">
            Comprehensive Hospital Management System for efficient healthcare
            administration
          </p>
        </header>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              >
                ...
                <p className="text-muted-foreground text-sm mb-4">
                  Manage patients, visits, doctors, and hospital records. Upload
                  and process CSV data.
                </p>
              ...
              >
                ...
                <p className="text-muted-foreground text-sm mb-4">
                  Access your patients, manage prescriptions, and track visit
                  outcomes.
                </p>
                <div className="flex items-center gap-4 text-xs text-muted-foreground">
                  <span className="flex items-center gap-1">
