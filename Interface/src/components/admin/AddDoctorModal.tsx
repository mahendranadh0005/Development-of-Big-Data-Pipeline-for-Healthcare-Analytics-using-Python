...
export default function AddDoctorModal({ open, onClose }: AddDoctorModalProps) {
  ...
  const validate = () => {
    ...
    if (!formData.doctor_speciality)
      newErrors.doctor_speciality = "Speciality is required";
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await api.post("/auth/register-doctor", {
        ...
        speciality: formData.doctor_speciality,
      });

      toast({
        title: "Doctor Added",
        description: `${formData.doctor_name} has been registered successfully.`,
      });
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value) =>
                setFormData({ ...formData, doctor_speciality: value })
              }
            >
              <SelectTrigger
                className={errors.doctor_speciality ? "border-destructive" : ""}
              >
